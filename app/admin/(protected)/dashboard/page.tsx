    ...
    return (
        <div className="p-8 space-y-8">
            ...
            <div className="grid gap-4 md:grid-cols-3">
                ...
                <div className="p-6 rounded-2xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Active Pages</h3>
                        <Users className="text-orange-500" size={20} />
                    </div>
                    <div className="text-3xl font-bold">{stats.topPages.length}</div>
                    <p className="text-xs text-gray-500 mt-1">Pages with traffic</p>
                </div>
            </div>
